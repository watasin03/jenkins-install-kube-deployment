...
7. setup jenkins from web browser
    ...
    copy Admin Password from line
        ...
        a89edc55f5a4448faa2bc6f42b07a23a

    
    install recommend plugins
    setup username and password

8. install optional plugins
